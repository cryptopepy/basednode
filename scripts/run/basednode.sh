...
function run_command()
{
    ...
    MAINNET_BOOTNODE='--bootnodes /dns/bootnode.prometheus.getbased.ai/tcp/30333/ws/p2p/12D3KooWRwbMb85RWnT8DSXSYMWQtuDwh4LJzndoRrTDotTR5gDC'
    TESTNET_BOOTNODE='--bootnodes /dns/bootnode.test.prometheus.getbased.ai/tcp/30333/ws/p2p/12D3KooWRwbMb85RWnT8DSXSYMWQtuDwh4LJzndoRrTDotTR5gDC'
...
NODE_TYPE="lite"
BUILD=""
BIN_PATH="./target/release/basednode"
