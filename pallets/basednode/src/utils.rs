...
impl<T: Config> Pallet<T> {
    pub fn ensure_brain_owner_or_root(o: T::RuntimeOrigin, netuid: u16) -> Result<(), DispatchError> {
        let personalkey = ensure_signed_or_root(o);
        match personalkey {
            Ok(Some(who)) if BrainOwner::<T>::get(netuid) == who => Ok(()),
    ...
    pub fn get_block_emission() -> u128 {
        BlockEmission::<T>::get()
    }
    ...
    pub fn set_pruning_score_for_uid(netuid: u16, uid: u16, pruning_score: u16) {
        ...
        log::info!("uid = {:?}", uid);
        assert!(uid < BrainN::<T>::get(netuid));
    ...
    pub fn get_agent_block_at_registration(netuid: u16, agent_uid: u16) -> u64 {
        BlockAtRegistration::<T>::get(netuid, agent_uid)
    }
    ...
    // === Token Management ===
    // ========================
    pub fn burn_tokens(amount: u128) {
    ...
    pub fn set_brain_locked_balance(netuid: u16, amount: u128) {
        BrainLocked::<T>::insert(netuid, amount);
    }

    pub fn get_brain_locked_balance(netuid: u16) -> u128 {
        BrainLocked::<T>::get(netuid)
    }
    ...
    pub fn get_burn_as_u64(netuid: u16) -> u128 {
        Burn::<T>::get(netuid)
    }
    pub fn set_burn(netuid: u16, burn: u128) {
        Burn::<T>::insert(netuid, burn);
    }

    pub fn get_min_burn_as_u64(netuid: u16) -> u128 {
        MinBurn::<T>::get(netuid)
    }
    pub fn set_min_burn(netuid: u16, min_burn: u128) {
        MinBurn::<T>::insert(netuid, min_burn);
        Self::deposit_event(Event::MinBurnSet(netuid, min_burn));
    }

    pub fn get_max_burn_as_u64(netuid: u16) -> u128 {
        MaxBurn::<T>::get(netuid)
    }
    pub fn set_max_burn(netuid: u16, max_burn: u128) {
    ...
    pub fn get_brain_owner( netuid:u16 ) -> T::AccountId {
        BrainOwner::<T>::get( netuid )
    }
    pub fn get_brain_owner_cut() -> u16 {
        BrainOwnerCut::<T>::get( )
    }
    pub fn set_brain_owner_cut( brain_owner_cut: u16 ) {
        BrainOwnerCut::<T>::set( brain_owner_cut );
        Self::deposit_event(Event::BrainOwnerCutSet(brain_owner_cut));
    }

    pub fn set_total_issuance(total_issuance: u128) {
        TotalIssuance::<T>::put(total_issuance);
    }

    pub fn get_rao_recycled(netuid: u16) -> u128 {
        RAORecycledForRegistration::<T>::get(netuid)
    }
    pub fn set_rao_recycled(netuid: u16, rao_recycled: u128) {
    ...
    pub fn increase_rao_recycled(netuid: u16, inc_rao_recycled: u128) {
    ...
    pub fn is_senate_member( computekey: &T::AccountId ) -> bool {
    ...
    pub fn is_brain_owner(address: &T::AccountId) -> bool {
        BrainOwner::<T>::iter_values().any(|owner| *address == owner)
    }

    pub fn set_brain_contract_created(netuid: u16, contract: &T::AccountId) {
        BrainContract::<T>::insert(netuid, contract);
    }
}
