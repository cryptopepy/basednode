...
//         let modality = 0;
//         let tempo: u16 = 13;
//         let call = RuntimeCall::BasedNode(BasednodeCall::sudo_add_network {
//             netuid,
//             tempo,
//             modality,
//         });
...
//         assert_eq!(BasedNode::get_number_of_brains(), 1);
//         add_network(20, tempo, modality);
//         assert_eq!(BasedNode::get_number_of_brains(), 2);
//     });
// }
...
//         let modality = 0;
//         let tempo: u16 = 13;
//         assert_eq!(BasedNode::get_tempo(1), 0);
//         add_network(1, tempo, modality);
//         assert_eq!(BasedNode::get_tempo(1), 13);
//     });
// }
...
//         register_ok_agent(1, U256::from(55), U256::from(66), 0);
//         BasedNode::set_min_allowed_weights(netuid, min_allowed_weight);
//         assert_eq!(BasedNode::get_min_allowed_weights(netuid), 2);
//         assert_ok!(BasedNode::do_remove_network(
//             <<Test as Config>::RuntimeOrigin>::root(),
//             netuid
//         ));
//         assert_eq!(BasedNode::get_min_allowed_weights(netuid), 0);
//     });
// }
...
//         register_ok_agent(1, U256::from(55), U256::from(66), 0);
//         let agent_id;
//         match BasedNode::get_uid_for_net_and_computekey(netuid, &U256::from(55)) {
//             Ok(k) => agent_id = k,
//             Err(e) => panic!("Error: {:?}", e),
//         }
//         assert!(BasedNode::get_uid_for_net_and_computekey(netuid, &U256::from(55)).is_ok());
//         assert_eq!(agent_id, 0);
//         register_ok_agent(1, U256::from(56), U256::from(67), 300000);
//         let agent_uid =
//             BasedNode::get_uid_for_net_and_computekey(netuid, &U256::from(56)).unwrap();
//         assert_eq!(agent_uid, 1);
//         assert_ok!(BasedNode::do_remove_network(
//             <<Test as Config>::RuntimeOrigin>::root(),
//             netuid
//         ));
//         assert!(BasedNode::get_uid_for_net_and_computekey(netuid, &U256::from(55)).is_err());
//     });
// }
...
//         add_network(netuid, tempo, 0);
//         register_ok_agent(1, U256::from(55), U256::from(66), 0);
//         assert_ok!(BasedNode::sudo_set_difficulty(
//             <<Test as Config>::RuntimeOrigin>::root(),
//             netuid,
//             difficulty
//         ));
//         assert_eq!(BasedNode::get_difficulty_as_u64(netuid), difficulty);
//         assert_ok!(BasedNode::do_remove_network(
//             <<Test as Config>::RuntimeOrigin>::root(),
//             netuid
//         ));
...
// #[test]
// fn test_remove_network_for_all_computekeys() {
//     new_test_ext().execute_with(|| {
//         let netuid: u16 = 1;
//         let tempo: u16 = 13;
//         add_network(netuid, tempo, 0);
//         register_ok_agent(1, U256::from(55), U256::from(66), 0);
//         register_ok_agent(1, U256::from(77), U256::from(88), 65536);
...
//         add_network(netuid, tempo, 0);
//         assert_eq!(BasedNode::get_min_allowed_weights(netuid), 0);
//         assert_eq!(BasedNode::get_emission_value(netuid), 0);
//         assert_eq!(BasedNode::get_max_weight_limit(netuid), u16::MAX);
//         assert_eq!(BasedNode::get_difficulty_as_u64(netuid), 10000);
...
//         let call = RuntimeCall::BasedNode(BasednodeCall::sudo_set_emission_values {
//             netuids,
//             emission,
//         });
//         assert_eq!(
...
//         add_network(1, 0, 0);
//         add_network(2, 0, 0);
//         assert_ok!(BasedNode::sudo_set_emission_values(
//             <<Test as Config>::RuntimeOrigin>::root(),
//             netuids,
//             emission
//         ));
...
//         add_network(2, 0, 0);
//         assert_eq!(
//             BasedNode::sudo_set_emission_values(
//                 <<Test as Config>::RuntimeOrigin>::root(),
//                 netuids,
//                 emission
//             ),
