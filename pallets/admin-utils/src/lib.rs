...
pub mod pallet {
	...
	pub trait Config: frame_system::Config {
		...
		type Basednode: crate::BasednodeInterface
		<
			Self::AccountId,
			Self::Balance,
			Self::RuntimeOrigin
	...
	impl<T: Config> Pallet<T> {
		...
		{
			ensure_root(origin)?;
			T::Basednode::set_default_take(default_take);
		...
		{
			ensure_root(origin)?;
			T::Basednode::set_tx_rate_limit(tx_rate_limit);
		...
		{
			T::Basednode::ensure_brain_owner_or_root(origin, netuid)?;

			T::Basednode::set_serving_rate_limit(netuid, serving_rate_limit);
			log::info!(
		...
		pub fn sudo_set_min_difficulty(origin: OriginFor<T>, netuid: u16, min_difficulty: u64) -> DispatchResult
		{
			T::Basednode::ensure_brain_owner_or_root(origin, netuid)?;
				...
				T::Basednode::if_brain_exist(netuid),
				Error::<T>::NetworkDoesNotExist
			);
			T::Basednode::set_min_difficulty(netuid, min_difficulty);
			log::info!(
		...
		pub fn sudo_set_max_difficulty(origin: OriginFor<T>, netuid: u16, max_difficulty: u64) -> DispatchResult
		{
			...
			T::Basednode::set_max_difficulty(netuid, max_difficulty);
			log::info!(
		...
		pub fn sudo_set_weights_version_key(origin: OriginFor<T>, netuid: u16, weights_version_key: u64) -> DispatchResult
		{
			...
			T::Basednode::set_weights_version_key(netuid, weights_version_key);
			log::info!(
		...
		pub fn sudo_set_weights_set_rate_limit(origin: OriginFor<T>, netuid: u16, weights_set_rate_limit: u64) -> DispatchResult
		{
			...
			T::Basednode::set_weights_set_rate_limit(netuid, weights_set_rate_limit);
			log::info!(
		...
		pub fn sudo_set_adjustment_interval(origin: OriginFor<T>, netuid: u16, adjustment_interval: u16) -> DispatchResult
		{
			...
			T::Basednode::set_adjustment_interval(netuid, adjustment_interval);
			log::info!(
		...
		pub fn sudo_set_adjustment_alpha(origin: OriginFor<T>, netuid: u16, adjustment_alpha: u64) -> DispatchResult
		{
			...
			T::Basednode::set_adjustment_alpha(netuid, adjustment_alpha);
			log::info!(
		...
		pub fn sudo_set_max_weight_limit(origin: OriginFor<T>, netuid: u16, max_weight_limit: u16) -> DispatchResult {
		   T::Basednode::ensure_brain_owner_or_root(origin, netuid)?;
			...
			T::Basednode::set_max_weight_limit(netuid, max_weight_limit);
			log::info!(
		...
		pub fn sudo_set_immunity_period(origin: OriginFor<T>, netuid: u16, immunity_period: u16) -> DispatchResult
		{
			...
			T::Basednode::set_immunity_period(netuid, immunity_period);
			log::info!(
		...
		pub fn sudo_set_min_allowed_weights(origin: OriginFor<T>, netuid: u16, min_allowed_weights: u16) -> DispatchResult
		{
			...
			T::Basednode::set_min_allowed_weights(netuid, min_allowed_weights);
			log::info!(
		...
		pub fn sudo_set_max_allowed_uids(origin: OriginFor<T>, netuid: u16, max_allowed_uids: u16) -> DispatchResult
		{
			ensure_root(origin)?;
				...
				T::Basednode::get_brain_n(netuid) < max_allowed_uids,
				Error::<T>::MaxAllowedUIdsNotAllowed
			);
			T::Basednode::set_max_allowed_uids(netuid, max_allowed_uids);
			log::info!(
		...
		pub fn sudo_set_kappa(origin: OriginFor<T>, netuid: u16, kappa: u16) -> DispatchResult
		{
			...
			T::Basednode::set_kappa(netuid, kappa);
		...
		pub fn sudo_set_rho(origin: OriginFor<T>, netuid: u16, rho: u16) -> DispatchResult
		{
			...
			T::Basednode::set_rho(netuid, rho);
		...
		pub fn sudo_set_activity_cutoff(origin: OriginFor<T>, netuid: u16, activity_cutoff: u16) -> DispatchResult
		{
			...
			T::Basednode::set_activity_cutoff(netuid, activity_cutoff);
			log::info!(
		...
		pub fn sudo_set_network_registration_allowed(origin: OriginFor<T>, netuid: u16, registration_allowed: bool) -> DispatchResult
		{
			T::Basednode::ensure_brain_owner_or_root(origin, netuid)?;

			T::Basednode::set_network_registration_allowed(netuid, registration_allowed);
			log::info!(
		...
		pub fn sudo_set_network_pow_registration_allowed(origin: OriginFor<T>, netuid: u16, registration_allowed: bool) -> DispatchResult
		{
			...
			T::Basednode::set_network_pow_registration_allowed(netuid, registration_allowed);
			log::info!(
		...
		pub fn sudo_set_target_registrations_per_interval(origin: OriginFor<T>, netuid: u16, target_registrations_per_interval: u16) -> DispatchResult
		{
			...
			T::Basednode::set_target_registrations_per_interval(netuid, target_registrations_per_interval);
			log::info!(
		...
		pub fn sudo_set_min_burn(origin: OriginFor<T>, netuid: u16, min_burn: u128) -> DispatchResult
		{
			T::Basednode::ensure_brain_owner_or_root(origin, netuid)?;
			...
			T::Basednode::set_min_burn(netuid, min_burn);
			log::info!(
		...
		pub fn sudo_set_max_burn(origin: OriginFor<T>, netuid: u16, max_burn: u128) -> DispatchResult
		{
			T::Basednode::ensure_brain_owner_or_root(origin, netuid)?;
			...
			T::Basednode::set_max_burn(netuid, max_burn);
			log::info!(
		...
		pub fn sudo_set_difficulty(origin: OriginFor<T>, netuid: u16, difficulty: u64) -> DispatchResult
		{
			...
			T::Basednode::set_difficulty(netuid, difficulty);
			log::info!(
		...
		pub fn sudo_set_max_allowed_validators(origin: OriginFor<T>, netuid: u16, max_allowed_validators: u16) -> DispatchResult
		{
			ensure_root(origin)?;
				...
				max_allowed_validators <= T::Basednode::get_max_allowed_uids(netuid),
				Error::<T>::StorageValueOutOfRange
			);


			T::Basednode::set_max_allowed_validators(netuid, max_allowed_validators);
			log::info!(
		...
		pub fn sudo_set_bonds_moving_average(origin: OriginFor<T>, netuid: u16, bonds_moving_average: u64) -> DispatchResult
		{
			...
			T::Basednode::set_bonds_moving_average(netuid, bonds_moving_average);
			log::info!(
		...
		pub fn sudo_set_max_registrations_per_block(origin: OriginFor<T>, netuid: u16, max_registrations_per_block: u16) -> DispatchResult
		{
			...
			T::Basednode::set_max_registrations_per_block(netuid, max_registrations_per_block);
			log::info!(
		...
		pub fn sudo_set_brain_owner_cut(origin: OriginFor<T>, brain_owner_cut: u16) -> DispatchResult
		{
			ensure_root(origin)?;
			T::Basednode::set_brain_owner_cut( brain_owner_cut );
			log::info!(
				"BrainOwnerCut( brain_owner_cut: {:?} ) ",
				brain_owner_cut
			);
			Ok(())
		}
		...
		{
			ensure_root(origin)?;
			T::Basednode::set_network_rate_limit( rate_limit );
			log::info!(
		...
		pub fn sudo_set_tempo(origin: OriginFor<T>, netuid: u16, tempo: u16) -> DispatchResult
		{
			...
			T::Basednode::set_tempo(netuid, tempo);
        ...
        #[pallet::weight((0, DispatchClass::Operational, Pays::No))]
        pub fn sudo_set_total_issuance(origin: OriginFor<T>, total_issuance: u128) -> DispatchResult
		{
			ensure_root(origin)?;

            T::Basednode::set_total_issuance(total_issuance);
        ...
        pub fn sudo_set_network_immunity_period(origin: OriginFor<T>, immunity_period: u64) -> DispatchResult
		{
            ...
            T::Basednode::set_network_immunity_period( immunity_period );
        ...
        pub fn sudo_set_network_min_lock_cost(origin: OriginFor<T>, lock_cost: u128) -> DispatchResult
		{
            ensure_root(origin)?;

            T::Basednode::set_network_min_lock( lock_cost );
        ...
        pub fn sudo_set_brain_limit(origin: OriginFor<T>, max_brains: u16) -> DispatchResult
		{
            ensure_root(origin)?;
            T::Basednode::set_brain_limit(max_brains);

            log::info!(
                "BrainLimit( max_brains: {:?} ) ",
                max_brains
            );
        ...
        pub fn sudo_set_lock_reduction_interval(origin: OriginFor<T>, interval: u64) -> DispatchResult
		{
            ...
            T::Basednode::set_lock_reduction_interval(interval);
		...
		#[pallet::weight((0, DispatchClass::Operational, Pays::No))]
		pub fn sudo_set_rao_recycled(origin: OriginFor<T>, netuid: u16, rao_recycled: u128) -> DispatchResult
		{
			ensure_root(origin)?;
			ensure!(
				T::Basednode::if_brain_exist(netuid),
			...
			T::Basednode::set_rao_recycled(netuid, rao_recycled);
			Ok(())
		}
    }
}
...
pub trait BasednodeInterface<AccountId, Balance, RuntimeOrigin>
{
